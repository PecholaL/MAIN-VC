...
class Inferencer(object):
    ...
    def inference_from_path(self):
        ...
        src_mel = log_mel_spectrogram(src_wav, hp.preemph, hp.sr, hp.n_mels, hp.n_fft, hp.hop_len, hp.win_len, hp.f_min)
        tar_mel = log_mel_spectrogram(tar_wav, hp.preemph, hp.sr, hp.n_mels, hp.n_fft, hp.hop_len, hp.win_len, hp.f_min)
        ...
        write(f'{self.arg.output}/{src_info}_{tar_info}.wav', rate=self.args.sample_rate, data=conv_wav)
        return


if __name__ == '__main__':
    parser = ArgumentParser()
    parser.add_argument('-attr', '-a', help='attr file path', default='/Users/pecholalee/Coding/VC/mainVc_data/attr.pkl')
    parser.add_argument('-config', '-c', help='config file path', default='/Users/pecholalee/Coding/VC/MAIN-VC/config.yaml')
    parser.add_argument('-model', '-m', help='model path', default='/Users/pecholalee/Coding/VC/mainVc_data/save/mainVcModel.ckpt')
    parser.add_argument('-vocoder', '-v', help='vocoder path', default='/Users/pecholalee/Coding/VC/mainVc_data/vocoder/vocoder.pt')
