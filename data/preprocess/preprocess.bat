...
%PYTHON_PATH% "C:\Users\leeklll\Documents\DL\MAIN-VC\data\preprocess\make_datasets.py" "%RAW_DATA_DIR%\wav48" "%RAW_DATA_DIR%\speaker-info.txt" "%DATA_DIR%" "%N_OUT_SPEAKERS%" "%TEST_PROP%" "%N_UTT_ATTR%"

%PYTHON_PATH% "C:\Users\leeklll\Documents\DL\MAIN-VC\data\preprocess\sample_dataset.py" "%DATA_DIR%\train.pkl" "%DATA_DIR%\speaker2filenames.pkl" "%DATA_DIR%\train_samples_%SEGMENT_SIZE%.json" "%TRAINING_SAMPLES%" "%SEGMENT_SIZE%"
